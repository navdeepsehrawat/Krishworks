...
<form action="" method="POST">
   ...
   <input placeholder="Enter marks X" type="text" name="names" id="names">
...
$result = mysqli_query($conn,"SELECT student_name, phone_number, subject1_marks, subject2_marks, subject3_marks, subject4_marks, subject5_marks, total,email FROM student where total> '$search_id'");
